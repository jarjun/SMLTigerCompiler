...
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !commentDepth = 1 then YYBEGIN INITIAL else ();
				   commentDepth := !commentDepth - 1;
				   continue()))
...
fun yyAction7 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringInProgress := !stringInProgress ^ "\\"; continue()))
...
fun yyAction17 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos (" invalid character " ^ yytext ^ " in formatting block"); continue())
      end
fun yyAction18 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos (" invalid escape sequence"); continue()))
fun yyAction19 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringInProgress := !stringInProgress ^ yytext; continue())
      end
fun yyAction20 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos (" non printable character in string"); continue()))
fun yyAction21 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringInProgress := !stringInProgress ^ yytext; lineNum := !lineNum+1; linePos := yypos :: !linePos; 
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction39(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction39(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ109(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ113(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ119 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction64(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ119(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp < #"0"
        ...
        | SOME(inp, strm') =>
            if inp = #"3"
              ...
              then if inp = #"]"
                  ...
                  then if inp = #"\\"
                      then yyQ14(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                      else yyAction18(strm, yyNO_MATCH)
                else if inp = #"^"
                  then yyQ15(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                  else yyAction18(strm, yyNO_MATCH)
            else if inp = #"o"
              then yyAction18(strm, yyNO_MATCH)
            else if inp < #"o"
